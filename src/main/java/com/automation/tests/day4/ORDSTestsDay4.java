...
//        baseURI="http://54.224.118.38:1000/ords/hr";
        baseURI="http://3.90.112.152:1000/ords/hr/employees";
    ...
    @Test
    @DisplayName("Verify that every employee has a positive salary")
...
//            */
    ...
    public void verifyPhoneNumber(){
        Response response=when().get("/employee/{id}",101);
